...
class TestDelete:
    ...
    def test_delete_not_found(self):
        ...
        result = client.delete("resource_governor", "x")
...
class TestList:
    ...
    def test_list_empty(self):
        ...
        assert len(client.list("resource_governor")) == 0
...
class TestGet:
    def test_get_existing(self):
        ...
        assert client.get("resource_governor", "123")["name"] == "test"

    def test_get_not_found(self):
        client = MagicMock()
        client.get.return_value = None
        assert client.get("resource_governor", "x") is None
