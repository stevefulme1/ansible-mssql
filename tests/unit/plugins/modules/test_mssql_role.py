...
"""Unit tests for mssql_role module."""
...
class TestGet:
    def test_get_existing(self):
        ...
        assert client.get("role", "123")["name"] == "test"

    def test_get_not_found(self):
        client = MagicMock()
        client.get.return_value = None
        assert client.get("role", "x") is None
