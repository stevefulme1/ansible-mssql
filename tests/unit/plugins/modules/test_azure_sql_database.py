...
class TestDelete:
    ...
    def test_delete_not_found(self):
        ...
        result = client.delete("sql_database", "x")
...
class TestList:
    ...
    def test_list_empty(self):
        ...
        assert len(client.list("sql_database")) == 0
...
class TestGet:
    def test_get_existing(self):
        ...
        assert client.get("sql_database", "123")["name"] == "test"

    def test_get_not_found(self):
        client = MagicMock()
        client.get.return_value = None
        assert client.get("sql_database", "x") is None
