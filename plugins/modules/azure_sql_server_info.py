...
DOCUMENTATION = r"""
---
module: azure_sql_server_info
short_description: Retrieve sql server information
description:
    - Retrieve details about sql servers.
    - Read-only module.
version_added: "1.0.0"
author:
...
EXAMPLES = r"""
- name: List all sql servers
  stevefulme1.mssql.azure_sql_server_info:
    host: api.example.com
  register: result

- name: Get a specific sql server
  stevefulme1.mssql.azure_sql_server_info:
    host: api.example.com
...
def main():
    ...
    if resource_id:
        result = client.get("sql_server", resource_id)
        ...
        resources = client.list("sql_server", module.params)

    module.exit_json(changed=False, sql_servers=resources)
