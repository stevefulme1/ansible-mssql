...
DOCUMENTATION = r"""
---
module: mssql_audit_info
short_description: Retrieve audit information
description:
    - Retrieve details about audits.
    - Read-only module.
version_added: "1.0.0"
author:
...
- name: List all audits
  stevefulme1.mssql.mssql_audit_info:
    host: api.example.com
  register: result

- name: Get a specific audit
  stevefulme1.mssql.mssql_audit_info:
    host: api.example.com
...
def main():
    ...
    if resource_id:
        result = client.get("audit", resource_id)
        ...
        resources = client.list("audit", module.params)

    module.exit_json(changed=False, audits=resources)
