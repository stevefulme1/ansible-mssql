...
DOCUMENTATION = r"""
---
module: mssql_tde_info
short_description: Retrieve tde information
description:
    - Retrieve details about tdes.
    - Read-only module.
version_added: "1.0.0"
author:
...
EXAMPLES = r"""
- name: List all tdes
  stevefulme1.mssql.mssql_tde_info:
    host: api.example.com
  register: result

- name: Get a specific tde
  stevefulme1.mssql.mssql_tde_info:
    host: api.example.com
    cert_name: "example-id"
  register: result
"""
...
def main():
    ...
    if resource_id:
        result = client.get("tde", resource_id)
        ...
        resources = client.list("tde", module.params)

    module.exit_json(changed=False, tdes=resources)
