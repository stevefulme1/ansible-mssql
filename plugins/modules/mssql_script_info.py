...
- name: List all scripts
  stevefulme1.mssql.mssql_script_info:
...
def main():
    ...
    if resource_id:
        result = client.get("script", resource_id)
        ...
        resources = client.list("script", module.params)

    module.exit_json(changed=False, scripts=resources)
