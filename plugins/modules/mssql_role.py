...
---
module: mssql_role
short_description: Manage SQL Server roles and permissions
description:
    - Manage SQL Server roles and permissions.
version_added: "1.0.0"
author:
...
def main():
    module = AnsibleModule(
        ...
        required_if=[("state", "absent", ("role_name",))],
    )
    ...
    if state == "present":
        ...
        if resource_id:
            ...
            candidates = client.list("role", {dict(name=module.params.get("name", ""))})
            if candidates:
