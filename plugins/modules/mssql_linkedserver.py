...
DOCUMENTATION = r"""
---
module: mssql_linkedserver
short_description: Manage SQL Server linked servers
description:
    - Manage SQL Server linked servers.
version_added: "1.0.0"
author:
...
options:
    ...
    host:
        ...
        required: true
    server_name:
        description: Unique identifier of the linkedserver.
        type: str
    name:
...
EXAMPLES = r"""
- name: Create a linkedserver
  stevefulme1.mssql.mssql_linkedserver:
    host: api.example.com
    name: my-linkedserver
    state: present

- name: Delete a linkedserver
  stevefulme1.mssql.mssql_linkedserver:
    host: api.example.com
...
def main():
    module = AnsibleModule(
        ...
        required_if=[("state", "absent", ("server_name",))],
    )
    ...
    if state == "present":
        ...
        if resource_id:
            ...
            candidates = client.list("linkedserver", {dict(name=module.params.get("name", ""))})
            if candidates:
