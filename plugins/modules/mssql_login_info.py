...
short_description: Retrieve login information
description:
    - Retrieve details about logins.
    - Read-only module.
version_added: "1.0.0"
author:
...
EXAMPLES = r"""
- name: List all logins
  stevefulme1.mssql.mssql_login_info:
    host: api.example.com
  register: result

- name: Get a specific login
  stevefulme1.mssql.mssql_login_info:
    host: api.example.com
...
def main():
    ...
    if resource_id:
        result = client.get("login", resource_id)
        ...
        resources = client.list("login", module.params)

    module.exit_json(changed=False, logins=resources)
