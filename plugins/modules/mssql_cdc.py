...
---
module: mssql_cdc
short_description: Manage SQL Server Change Data Capture
description:
    - Manage SQL Server Change Data Capture.
version_added: "1.0.0"
author:
...
options:
    ...
    host:
        ...
        required: true
    table_name:
        description: Unique identifier of the cdc.
        type: str
    name:
...
def main():
    module = AnsibleModule(
        ...
        required_if=[("state", "absent", ("table_name",))],
    )
    ...
    if state == "present":
        ...
        if resource_id:
            ...
            candidates = client.list("cdc", {dict(name=module.params.get("name", ""))})
            if candidates:
