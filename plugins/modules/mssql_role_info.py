...
DOCUMENTATION = r"""
---
module: mssql_role_info
short_description: Retrieve role information
description:
    - Retrieve details about roles.
    - Read-only module.
version_added: "1.0.0"
author:
...
EXAMPLES = r"""
- name: List all roles
  stevefulme1.mssql.mssql_role_info:
...
def main():
    ...
    resource_id = module.params.get("role_name")

    if resource_id:
        result = client.get("role", resource_id)
        ...
        resources = client.list("role", module.params)

    module.exit_json(changed=False, roles=resources)
