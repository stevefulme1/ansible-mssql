...
- name: List all credentials
  stevefulme1.mssql.mssql_credential_info:
    host: api.example.com
  register: result

- name: Get a specific credential
  stevefulme1.mssql.mssql_credential_info:
    host: api.example.com
...
def main():
    ...
    if resource_id:
        result = client.get("credential", resource_id)
        ...
        resources = client.list("credential", module.params)

    module.exit_json(changed=False, credentials=resources)
