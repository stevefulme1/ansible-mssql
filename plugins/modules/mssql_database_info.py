...
short_description: Retrieve database information
description:
    - Retrieve details about databases.
    - Read-only module.
version_added: "1.0.0"
author:
...
def main():
    ...
    if resource_id:
        result = client.get("database", resource_id)
        ...
        resources = client.list("database", module.params)

    module.exit_json(changed=False, databases=resources)
