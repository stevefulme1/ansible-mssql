...
---
module: mssql_tde
short_description: Manage SQL Server Transparent Data Encryption
description:
    - Manage SQL Server Transparent Data Encryption.
version_added: "1.0.0"
author:
...
options:
    ...
    host:
        ...
        required: true
    cert_name:
        description: Unique identifier of the tde.
        type: str
    name:
...
def main():
    module = AnsibleModule(
        ...
        required_if=[("state", "absent", ("cert_name",))],
    )
    ...
    if state == "present":
        ...
        if resource_id:
            ...
            candidates = client.list("tde", {dict(name=module.params.get("name", ""))})
            if candidates:
