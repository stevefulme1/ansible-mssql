...
DOCUMENTATION = r"""
---
module: mssql_replication
short_description: Manage SQL Server replication
description:
...
options:
    ...
    host:
        ...
        required: true
    publication_name:
        description: Unique identifier of the replication.
        type: str
    name:
...
EXAMPLES = r"""
- name: Create a replication
  stevefulme1.mssql.mssql_replication:
...
def main():
    module = AnsibleModule(
        ...
        required_if=[("state", "absent", ("publication_name",))],
    )
    ...
    if state == "present":
        ...
        if resource_id:
            ...
            candidates = client.list("replication", {dict(name=module.params.get("name", ""))})
            if candidates:
